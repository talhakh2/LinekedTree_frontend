...
export default function SpinDesign({ gameFormat }) {
    ...
    return (
        <>
            {/* <div class="relative h-24 w-full" style={{ backgroundColor: gameFormat.buttonColor }}>
                <div class="absolute inset-0 bg-white clip-path-half-circle">
            ...
            <div className='flex flex-col justify-center items-center'>
                {/* <div className='grid grid-col justify-between mx-auto items-center'>
                    <div className="container mt-8 mb-10 md:mb-0">
                ...
                <img src={wheelColor}
                    alt="" style={{ marginTop: '-100px' }} />
            </div>


            <div className="grid grid-cols-2 justify-end max-md:mt-4">

                <div className="flex justify-center mt-4 ml-4 font-bold text-xl text-center" style={{ color: gameFormat.buttonColor, width: '80%' }}>
