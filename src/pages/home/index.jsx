            ...
            <div className="flex flex-col md:flex-row mx-4 md:mx-0 items-center relative">
                ...
                <div className="flex-1 relative md:ml-10 mt-5">
                    <div style={{zIndex: 10}} className="text-3xl z-2 font-bold text-black leading-[39px] max-w-[596px]">
                        Simplifiez la présence en ligne de votre restaurant
                    </div>
                    <div style={{zIndex: 10}} className="text-base font-medium mt-5 leading-5 w-full text-neutral-800">
                        Intégrez sans effort des outils et des plateformes en ligne pour améliorer
                        la visibilité de votre restaurant, interagir avec les clients et renforcer
                        votre réputation en ligne. De la gestion des profils sur les réseaux sociaux
                        à l'optimisation de la présence sur les moteurs de recherche, notre solution
                        vous permet de rationaliser chaque aspect de la présence en ligne de votre
                        restaurant pour un impact et un succès maximaux.
                    </div>
